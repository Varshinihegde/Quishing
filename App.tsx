...
const App: React.FC = () => {
  ...
  const runAnalysis = async (content: string | null, base64: string | null) => {
    ...
    try {
      ...
      setState(prev => ({ 
        ...prev, 
        error: err.message || "Deep analysis failed.", 
        loading: false 
      }));
    }
  };
      ...
      <main className="flex-1 max-w-4xl mx-auto w-full px-6 py-10">
        ...
        {state.loading && (
          <div className="flex flex-col items-center justify-center py-40 space-y-8 animate-in fade-in">
            ...
            <div className="text-center">
              <h2 className="text-2xl font-bold">Deep AI Inspection...</h2>
              <p className="text-slate-500 text-xs font-bold uppercase tracking-widest mt-2">Checking redirects & patterns</p>
            </div>
          </div>
        )}
        ...
        {state.error && (
          <div className="text-center py-20 animate-in zoom-in max-w-md mx-auto">
            ...
            <h2 className="text-3xl font-black mb-4">Inspection Failed</h2>
